...
import { Plus, Download, Edit, Trash2, FileEdit, Filter, CheckCircle2, Clock } from "lucide-react";
...
const DEFAULT_ASSIGNMENTS = [
  { id: 1, date: "10 Juni 2024", dueDate: "17 Juni 2024", className: "X TKJ 1", major: "Teknik Komputer dan Jaringan", majorCode: "TKJ", subject: "Informatika", teacher: "Pak Budi Santoso", title: "Tugas Membuat Program Sederhana", status: "Berlangsung" },
  { id: 2, date: "11 Juni 2024", dueDate: "18 Juni 2024", className: "X TKJ 1", major: "Teknik Komputer dan Jaringan", majorCode: "TKJ", subject: "Matematika", teacher: "Bu Siti Aminah", title: "Tugas Soal Matematika", status: "Berlangsung" },
  { id: 3, date: "05 Juni 2024", dueDate: "12 Juni 2024", className: "X TKR 1", major: "Teknik Kendaraan Ringan", majorCode: "TKR", subject: "Dasar-Dasar Program Keahlian", teacher: "Pak Anton Wijaya", title: "Tugas Menggambar Orto", status: "Selesai" },
];
...
export default function AssignmentPage() {
  ...
  const [assignments, setAssignments] = useState(() => {
    if (typeof window !== 'undefined') {
      const saved = localStorage.getItem('kurikulum-smk-assignments');
  ...
  useEffect(() => {
    if (isClient) {
      localStorage.setItem('kurikulum-smk-assignments', JSON.stringify(assignments));
    }
  ...
  const completedAssignments = filteredAssignments.filter((a: any) => a.status === "Selesai").length;
  const ongoingAssignments = filteredAssignments.filter((a: any) => a.status === "Berlangsung").length;
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case "Berlangsung": return <Clock size={16} />;
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold text-gray-800">Tugas</h3>
          <p className="text-sm text-gray-500">Monitoring pengumpulan tugas oleh semua guru</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl shadow-sm border p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="text-sm text-gray-500 mb-1">Total Tugas</h4>
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-3xl font-bold text-green-700">{completedAssignments}</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-xl shadow-sm border p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="text-sm text-blue-600 mb-1">Berlangsung</h4>
              <p className="text-3xl font-bold text-blue-700">{ongoingAssignments}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
        <table className="w-full">
          <thead className="bg-gray-50 border-b">
            <tr>
              <th className="px-6 py-4 text-left text-sm font-semibold text-gray-600">Tanggal Diberikan</th>
              <th className="px-6 py-4 text-left text-sm font-semibold text-gray-600">Tenggat</th>
              ...
              <th className="px-6 py-4 text-left text-sm font-semibold text-gray-600">Judul Tugas</th>
