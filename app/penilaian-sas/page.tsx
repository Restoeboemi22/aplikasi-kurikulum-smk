...
import { Plus, Download, Edit, Trash2, Award } from "lucide-react";

export default function FinalSemesterPage() {
  const [exams] = useState([
    { id: 1, startDate: "10 Desember 2024", endDate: "15 Desember 2024", semester: "Ganjil", academicYear: "2024/2025", status: "Terjadwal" },
    { id: 2, startDate: "10 Juni 2024", endDate: "15 Juni 2024", semester: "Genap", academicYear: "2023/2024", status: "Selesai" },
  ]);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold text-gray-800">SAS (Sumatif Akhir Semester)</h3>
          <p className="text-sm text-gray-500">Kelola penilaian akhir semester</p>
        </div>
