  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="login-wrap">
        <div className="relative min-h-screen overflow-hidden">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.18),_transparent_30%),radial-gradient(circle_at_bottom_right,_rgba(251,191,36,0.12),_transparent_24%),linear-gradient(140deg,_#020617_0%,_#0b1836_34%,_#0f3c88_72%,_#1d4ed8_100%)]"></div>
          <div className="absolute inset-0 bg-[linear-gradient(115deg,rgba(255,255,255,0.04)_0%,transparent_32%,rgba(245,158,11,0.08)_52%,transparent_72%),linear-gradient(180deg,rgba(255,255,255,0.05)_0%,transparent_100%)]"></div>
          <div className="absolute inset-0 opacity-[0.14] [background-image:linear-gradient(rgba(255,255,255,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.08)_1px,transparent_1px)] [background-size:84px_84px]"></div>
          <div className="absolute -left-24 top-10 h-72 w-72 rounded-full bg-amber-300/10 blur-3xl"></div>
          <div className="absolute bottom-0 right-0 h-96 w-96 rounded-full bg-sky-400/10 blur-3xl"></div>
          ...
          <div className="relative z-10 flex min-h-screen items-center justify-center p-4 sm:p-6">
            <div className="grid w-full max-w-6xl overflow-hidden rounded-[32px] border border-white/15 bg-white/10 shadow-[0_30px_120px_rgba(15,23,42,0.55)] backdrop-blur-2xl lg:grid-cols-[1.08fr_0.92fr]">
              <div className="relative hidden flex-col justify-between bg-gradient-to-br from-[#041127]/95 via-[#0d2f68]/90 to-[#2563eb]/80 p-10 text-white lg:flex">
                <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,0.06)_0%,transparent_38%,rgba(245,158,11,0.08)_100%)]"></div>
                <div className="absolute right-[-70px] top-1/2 h-72 w-72 -translate-y-1/2 rounded-full border border-white/10 bg-white/5 blur-sm"></div>
                <div className="relative">
                  ...
                  <p className="mt-4 max-w-xl text-base leading-7 text-blue-50/85">
                    Mendukung pengelolaan penilaian, jurnal mengajar, perangkat pembelajaran, dan data akademik dalam satu platform terpadu.
                  </p>
                </div>
                ...
                <div className="relative grid gap-4">
                  <div className="rounded-[24px] border border-white/10 bg-white/10 p-5 shadow-[0_20px_40px_rgba(2,6,23,0.18)] transition duration-300 hover:-translate-y-0.5 hover:bg-white/[0.14]">
                    ...
                    <p className="text-sm leading-6 text-blue-50/80">
                      Setiap pengguna masuk sesuai peran admin atau guru agar data sekolah tetap aman dan terfokus.
                    </p>
                  </div>
              ...
              <div className="bg-white/95 p-6 sm:p-8 lg:p-10">
                <div className="mx-auto w-full max-w-md">
                  <div className="mb-8 flex flex-col items-center text-center">
                    ...
                    <div className="mt-3 h-1 w-24 rounded-full bg-gradient-to-r from-amber-400 via-sky-500 to-blue-700"></div>
                  ...
                  {!configured && (
                    <div className="mb-4 flex items-start gap-2 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800 shadow-sm transition duration-200 hover:shadow-md">
                      ...
                      <span>
                        Firebase belum dikonfigurasi. Isi <code className="font-mono">.env.local</code> sesuai panduan, lalu jalankan ulang server.
                      </span>
                    </div>
                  )}

                  {error && (
                    <div className="mb-4 flex items-center gap-2 rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-800 shadow-sm transition duration-200 hover:shadow-md">
                      <AlertCircle size={18} />
                      <span>{error}</span>
                    </div>
                  )}
